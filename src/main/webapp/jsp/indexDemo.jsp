			...
			<div data-page="home" class="page">
				<div class="page-content">
					<div class="top-message">
						<img class="top-message-icon" src="/images/icon/29.png">
					...
					<div class="top-enter">
						<div class="top-enter-pay">
							<a class="external" href="${pageContext.request.contextPath}/jsp/payshebao/selectcity.jsp">
								<img src="/images/index/1.png" alt="无忧保"><h2>缴社保</h2>
							</a>
					...
					<div class="index-content">
						<a class="external content-left" href="${pageContext.request.contextPath}/shebaofuwu/">
							<img class="img" src="/images/index/4.png" alt="个人社保代缴">
							<div class="text">
						...
						<a class="external content-right" href="${pageContext.request.contextPath}/shebaodating/">
							<img class="img" src="/images/index/5.gif" alt="个人社保代缴">
							<div class="text">
					...
					<div class="index-content">
						<a class="external content-left" href="${pageContext.request.contextPath}/zhishebao/">
							<img class="img" src="/images/index/6.png" alt="个人社保代缴">
							<div class="text">
						...
						<a class="external content-right" href="${pageContext.request.contextPath}/canbaozhinan/">
							<img class="img" src="/images/index/7.png" alt="个人社保代缴">
							<div class="text">
					...
					<a class="external banner-recruit" href="${pageContext.request.contextPath}/chengshidaili/">
						<img class="recruit-img" src="/images/index/9.png" alt="个人社保代缴">
...
<script>
	...
	jyApp.share({
		title: "手机也能缴社保了！",
	   	...
	   	link: "<%=Constant.URL%>/jsp/middlepage/index.jsp?name=index&invitCode=${invitCode}",
