...
<%
	...
	for (Iterator iter = requestParams.keySet().iterator(); iter.hasNext();) {
        ...
        Logger.getLogger(this.getClass()).info("notifyUrl name="+name+"   valueStr="+valueStr);
    ...
    Logger.getLogger(this.getClass()).info("支付宝异步通知 订单号="+out_trade_no+" 支付状态="+trade_status+" 金额="+total_amount);
//    boolean verify_result = AlipayNotify.verify(params);

	boolean verify_result = AlipaySignature.rsaCheckV1(params, AlipayConfig.ALIPAY_PUBLIC_KEY, AlipayConfig.CHARSET, "RSA2");
    Logger.getLogger(this.getClass()).info("订单号="+out_trade_no+"  verify_result  "+verify_result);
