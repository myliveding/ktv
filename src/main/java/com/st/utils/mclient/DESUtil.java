...
public class DESUtil {
     ...
     * @throws Exception
     */
    public static String encrypt(String text, String key, String charset) throws InvalidKeyException,
     ...
     * @throws Exception
     */
    public static String encrypt(String text, byte[] key, String charset) throws InvalidKeyException,
            InvalidKeySpecException,NoSuchAlgorithmException,NoSuchPaddingException,BadPaddingException,
            IllegalBlockSizeException,UnsupportedEncodingException {
     ...
     * @throws Exception
     */
    public static String decrypt(String text, String key, String charset) throws InvalidKeyException,
            InvalidKeySpecException,NoSuchAlgorithmException,NoSuchPaddingException,BadPaddingException,
            IllegalBlockSizeException,UnsupportedEncodingException {
     ...
     * @throws Exception
     */
    public static String decrypt(String text, byte[] key, String charset) throws NoSuchAlgorithmException,
