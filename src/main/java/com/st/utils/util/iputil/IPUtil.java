package com.st.utils.util.iputil;
...
//			ip = "125.71.216.26";//成都
//			ip = "58.60.124.50";//深圳
			if(com.st.utils.util.text.StringUtils.isNotEmpty(ip)){
				String inputline="";
				String info="";
				try {
					Random r = new Random();
					...
					if(com.st.utils.util.text.StringUtils.isEmpty(info)){
	...
	public static City getCityByPhone(String memberMobile) {
		City city = new City();
		city.setFlag(false);
		if(com.st.utils.util.text.StringUtils.isNotEmpty(memberMobile)){
			String inputline="";
			String info="";
			try {
